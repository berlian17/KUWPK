            ...
            <div class="container">
                <div class="row">
                    ...
                    <article class="col-md-4 col-sm-6 col-xs-12 ">
                        <div class="post-item">
                            <div class="media-wrapper">
                                <img src="{{ asset('assets/images/blog/post-2.jpg') }}" alt="amazing caves coverimage" class="img-fluid">
                            </div>
                            <div class="content">
                    ...
                    <article class="col-md-4 col-sm-6 col-xs-12 ">
                        <div class="post-item">
                            <div class="media-wrapper">
                                <img src="{{ asset('assets/images/portfolio/portfolio-3.jpg') }}" alt="amazing caves coverimage" class="img-fluid">
                            </div>
                            <div class="content">
